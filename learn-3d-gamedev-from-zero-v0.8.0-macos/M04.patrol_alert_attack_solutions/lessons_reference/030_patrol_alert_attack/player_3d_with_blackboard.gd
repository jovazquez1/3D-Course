...
#ANCHOR:func_physics_process_definition
func _physics_process(delta: float) -> void:
#END:func_physics_process_definition
...
#ANCHOR:func_die_definition
func _die() -> void:
#END:func_die_definition
